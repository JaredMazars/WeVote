      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        >
          <div className="text-center lg:text-left">
            ...
            >
              <p className="text-sm text-blue-800 font-semibold mb-2">🧪 TEST MODE</p>
              <p className="text-xs text-blue-700">
                The temporary password will be shown on screen and logged to the console.
                In production, it will only be sent via email.
              </p>
            </motion.div> */}
          </div>
        </motion.div>
