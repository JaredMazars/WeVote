...
import { ArrowLeft, Calendar, MapPin, User, Tag, CheckCircle, Sparkles, Clock } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-[#F4F4F4] flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-[#464B4B] mb-4">Event not found</h2>
          <button
            onClick={() => navigate('/voting/events')}
